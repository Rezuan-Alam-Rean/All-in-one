...
const Footer = () => {
    return (
        <div>
            ...
            <div className="footer p-5 justify-around  bg-slate-50  text-black">
                <div>
            ...
            <div className="p-2 footer-center bg-slate-50  text-base-content">
                    <div>
                        <p>Copyright © 2023 - All right reserved by 
                             Jannatul Ferdaus Putul</p>
                    </div>
                </div>
        </footer>
        </div>
